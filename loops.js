...
// for (let key in arr) console.log(`for in: key is ${key}, value is ${arr[key]}`);
  ...
  // Index 2 (or key 2) was deleted, it is now undefined,
  //   so it was not iterated over which is not enumerable.
  // Symbols are also non-enumerable, so it was not iterated over either.
